      ...
      <div className="container mx-auto">
        ...
        <div className=" mb-6 mx-auto px-3 bg-white/30 rounded-xl py-8 space-y-4">
          ...
          <div className="collapse collapse-plus bg-base-200">
            ...
            <div className="collapse-content">
              <p>
                Most of our products come with a one-year manufacturers
                warranty. Please refer to the product details for specifics.
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-plus bg-base-200">
            ...
            <div className="collapse-content">
              <p>
                After your order is shipped, we’ll send you a tracking number
                via email so you can monitor its delivery status.
              </p>
            </div>
          </div>
